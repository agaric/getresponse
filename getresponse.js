window.onload = function () {
  ...
  if (document.getElementById('gr-connect')) {
    document.getElementById('gr-connect').setAttribute('href', 'javascript:document.getElementById(\'getresponse-admin\').submit();');
  ...
  if (document.getElementById('edit-getresponse-api-key').value != '' &&
    ...
    document.getElementById('edit-submit').className = 'form-submit gr-btn-display-none';
  }
};
